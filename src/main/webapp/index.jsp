    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse align" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2 active" aria-current="page" href="index.jsp">Home</a>
                    </li>
                </ul>
            </div>
            <a class="btn btn-primary" href="login.jsp" role="button">Sign in</a>
        </div>
    </nav>
</header>
...
<div class="container">
            ...
            <p class="text-center fst-italic">Please, sign in to continue.</p>
